...
返回JSON（不要有其他内容）：
{
  ...
  "structure": {
    ...
    "cheng": "承——渣男/女二如何一次次升级伤害，女主陷入绝境、被所有人抛弃（60字内）。❌不写女主看清真相/逐渐觉醒/开始布局",
    "zhuan": "转——女主被虐到某个极限后决定离开/出走/离婚，写她离开的动作（60字内）。❌不写女主发现证据/策划复仇",
    "he": "合——男主得知真相追悔莫及，真相揭露，女主冷漠拒绝不回头（60字内）"
  },
  "event_flow": {
    "desire": "欲望——主角真正想要的（40字内）",
    "obstacle": "阻碍——主要障碍（用①②分点，80字内）",
    "action": "行动——女主的核心行动是：离开。写她如何离开、离开后的态度（40字内）。❌不写暗中调查/假装顺从/策划布局",
  ...
  "outline": [
    {
      "segment": "前段",
      "setup": "①（事件触发：谁做了什么——其他角色怎么反应，说了什么话——女主被迫面对什么结果。必须4-6句连续叙述，不能只写一句。参考合格示例的详细程度）\\n②（第二个事件，同样4-6句展开，有具体行为+对话+女主处境）\\n③（第三个事件）\\n④（第四个事件，第一阶段共4-5个事件）",
      "turning": "转折点——渣男/女二做了某件让局势突然恶化的行动，或女主被逼到极致做了一个妥协/沉默/顺从的行为（60字内）。❌绝对不是女主察觉/意识到/发现/推断出任何事",
      "emotion": "情绪点①——①（第一个情绪节点：什么具体场景→读者感受到什么）\\n②（第二个情绪节点）\\n③（第三个情绪节点）"
    },
    {
      "segment": "中段",
      "setup": "①（伤害升级事件：比第一阶段更深的伤害，触发→多人反应→女主处境，4-6句展开）\\n②（第二个事件，同样4-6句，有具体行为+对话+连锁反应）\\n③（第三个事件）\\n④（第四个事件，第二阶段共4-5个事件。第一+第二阶段合计必须达到8-9个完整事件）",
      "turning": "转折点——在又一次被虐之后，女主下定决心离开，写她拎包/出门/签字/消失的那个动作（60字内）。❌不是她发现了什么/查到了什么，是行动，不是认知。示例：「女主沉默地收拾了一个行李箱，趁夜离开」",
      "emotion": "情绪点②——①（第一个情绪节点：什么具体场景→读者感受到什么）\\n②（第二个情绪节点）\\n③（第三个情绪节点）"
    },
    {
      "segment": "后段",
      "setup": "①（男主回家发现空了：他看到了什么——第一反应——具体找了什么/做了什么，4-5句展开）\\n②（男主打电话找人：打给谁、对方怎么说/骂、男主的反应，4-5句）\\n③（男主翻到触目惊心的东西：日记/B超单/录像/旧照/短信——他读到/看到了什么具体内容——他当场的崩溃反应，4-6句展开）\\n④（男主去找女主：女主冷漠的具体态度、说了什么或不说什么、男主的反应，4-5句）\\n⑤（真相揭露：女二设局的证据或证人出现——男主得知真相——男主的具体崩溃反应，4-6句）\\n⑥（男主跪地求饶/追悔：做了什么具体行动——女主的最终态度和回应，如有更多情节继续写⑦⑧）",
