...
返回JSON（不要有其他内容）：
{
  "summary": "一句话梗概（30字内。写法示例：「结婚纪念日女儿惨死，被妹妹陷害送进精神病院，心死后决然离开」——写悲剧被虐感，不写觉醒复仇）",
  "structure": {
    "qi": "起——开篇情境（60字内）。写法示例：「结婚纪念日，女主的女儿在一场火灾中离世，妹妹跪地哭诉却将责任推向女主，丈夫将崩溃的她强制送进精神病院」",
    "cheng": "承——写渣男/女二的施害升级（60字内）。写法示例：「出院后丈夫逼迫女主反复献血给妹妹，父母当众说她心狠，儿子也叫妹妹小妈妈，女主被全家孤立」——只写对她做了什么，不写她发现了什么",
    "zhuan": "转——写女主离开的动作（60字内）。写法示例：「某个深夜，女主沉默地收拾了一个行李箱，把离婚协议放在桌上，趁丈夫熟睡时离开了家」——是离开动作，不是发现真相",
    "he": "合——男主后来发现真相（60字内）。写法示例：「男主在女主走后翻到了日记和监控，发现了女二的阴谋，疯狂追妻，但女主不再回头」——真相由男主自己发现"
  },
  "event_flow": {
    "desire": "欲望——女主最初只想要什么（40字内）。示例：「一个完整的家，女儿健康，丈夫不离不弃」",
    "obstacle": "阻碍——渣男和女二怎么施害（用①②分点，80字内）",
    "action": "行动——女主做的那一件事：离开（40字内）。写法示例：「某天清晨，女主沉默地拎着一个箱子出了门，什么都没说」——只写离开动作，不写调查/布局/揭露",
    "achieve": "达成——离开后男主发现真相追悔莫及（60字内）"
  },
  "characters": {
  ...
  "outline": [
    {
      "segment": "前段",
      "event_1": "【男主忽视女主场景，必须4句以上，禁止一句带过】写一次男主明显把女二放在女主前面的具体事件。要写：什么时候/什么情况下→男主的具体行为和说的话→女主的感受和处境，包含对话，像截取了一段故事。",
      "event_2": "【女二主动陷害女主场景，必须4句以上】写女二设局、说谎或故意挑衅让女主受罚的一个完整事件。要写：女二做了什么或说了什么→男主/家人信了→女主被怎样对待，包含具体对话。",
      "event_3": "【家人集体背刺场景，必须4句以上，含至少2句对话】写公婆/儿子/父母当面指责女主的场景。要写：起因→家人说了什么具体的话（写出原话）→女主的反应和处境，女主在场且没有人替她说话。",
      "event_4": "【公开羞辱/严重伤害场景，必填不能省略，必须4句以上】写一次在外人/众人面前，女主被严重羞辱或受到不公正对待的事件。要写：什么公开场合→发生了什么→旁观者的反应→女主当时的处境，是令她在外人面前颜面尽失的一次。",
      "event_5": "【可选第五件事：如有则继续写一个4句以上的事件，否则填「无」】",
      "turning": "转折点——渣男/女二做了某件让局势突然恶化的行动（60字内，❌不写女主察觉/发现任何真相）。示例：「丈夫在医院签字同意延长女主住院期，女主透过铁窗看见他签完字转身离去的背影」",
      "emotion": "情绪点①——①（具体场景→读者情绪）\\n②（第二个节点）\\n③（第三个节点）"
    },
    {
      "segment": "中段",
      "event_1": "【身体/精神极端伤害场景，必须4句以上，比第一阶段更严重】写一次女主受到更深程度伤害的事件——可以是身体伤害（意外/疾病无人管/被打）或精神崩溃（被逼到墙角哭泣/绝望到颤抖）。要写：触发→过程→女主当时的状态，每一句都要有具体细节。",
      "event_2": "【女主求助被拒场景，必须4句以上，有具体对话】写女主向某人（男主/闺蜜/父母/任何人）求助，被拒绝/被无视/被反骂的场景。要写：女主怎么开口的→对方说了什么→女主的反应，要有原话对话。",
      "event_3": "【女主反抗被压制场景，必须4句以上】写女主一次试图说出来或反抗，结果被更惨地对待的场景。要写：女主做了什么或说了什么→对方（男主/女二/家人）怎么反击→女主最终的处境比开始更糟。",
      "event_4": "【压垮骆驼的最后一根稻草，必填不能省略，必须4句以上】写那件让女主情感上彻底死心的事——不是发现阴谋，而是某个行为让她意识到这个家/这段婚姻已经没有她的位置了。要写：发生了什么→女主内心的那个「断」的瞬间→她的状态（沉默/眼泪/发呆），不写任何主动布局。",
      "event_5": "【可选第五件事：如有则继续写一个4句以上的升级事件，否则填「无」】",
      "turning": "转折点——写女主离开的那个动作（60字内，❌不写发现真相，只写她的离开行动）。示例：「那天傍晚，女主把离婚协议放在桌上，拎着一个箱子出了门，什么都没说，也没回头」",
      "emotion": "情绪点②——①（具体场景→读者情绪）\\n②（第二个节点）\\n③（第三个节点）"
    },
    {
      "segment": "后段",
      "event_1": "【⚠️此阶段全程男主视角，女主已离开，所有内容从男主角度写】男主回家发现空了（4-5句）：推开门看到什么→他第一反应做了什么→他的心理/行为，写他的慌乱和不相信。",
      "event_2": "【男主疯狂找人，4-5句，有对话】男主打电话给谁/去找谁→被骂/被挂断/被拒绝→他的反应，写他的狼狈，对方对他说的具体话。",
      "event_3": "【男主变得狼狈，4-5句】几天后男主的外表和状态——某人见到他的反应，或他做了某件说明他已经乱了的事，写具体细节。",
      "event_4": "【男主翻到触目惊心的东西，4-6句】男主翻到了什么（日记本/B超单/旧短信/视频录像）→里面具体写了什么或记录了什么→他当场是什么反应，写他崩溃的细节（手抖/跌坐/无法动弹）。",
      "event_5": "【男主找到女主，4-5句】男主在哪里找到了女主→女主的冷漠态度（具体说了什么或没说什么）→男主跪求/痛哭的具体样子，写女主「不回头」的状态。",
      "event_6": "【女二阴谋被男主发现，4-6句】男主通过什么（物证/第三方）发现了女二的具体阴谋内容→他对女二做了什么→他对整件事的崩溃反应，写他意识到自己错得多深。",
      "event_7": "【可选第七件：如有继续写男主后续一个4句以上的事件，否则填「无」】",
      "turning": "转折点——真相在男主面前揭露（60字内）。示例：「男主翻到那段视频，看见女二当晚和纵火者在一起，他手机掉在地上，久久没动」",
      "emotion": "情绪点③——①（男主追妻第一个爽点：女主冷漠拒绝的场景）\\n②（真相大白，渣男/旁人崩溃）\\n③（结局最解气的场景）"
    }
  ],
  "emotion_arc": {
...
- 不要在JSON之外输出任何内容`
  ...
  try {
    ...
    try {
      ...
      // Merge event_1..7 fields into setup for each outline segment
      if (parsed.outline && Array.isArray(parsed.outline)) {
        // eslint-disable-next-line @typescript-eslint/no-explicit-any
        parsed.outline = parsed.outline.map((seg: any) => {
          const nums = ['①','②','③','④','⑤','⑥','⑦']
          const events = ['event_1','event_2','event_3','event_4','event_5','event_6','event_7']
            .map((k, i) => seg[k] && seg[k] !== '无' ? `${nums[i]}${seg[k]}` : null)
            .filter(Boolean)
          if (events.length > 0) seg.setup = events.join('\\n')
          return seg
        })
      }
      return c.json(parsed)
