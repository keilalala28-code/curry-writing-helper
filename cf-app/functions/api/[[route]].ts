...
返回JSON（不要有其他内容）：
{
  ...
  "outline": [
    {
      "segment": "前段",
      "setup": "①（第一个场景：渣男/女二的具体行为+说的话+事情经过+女主当时状态，3-5句话，不是标签）\\n②（第二个场景，同样详细）\\n③（第三个场景）\\n④（第四个场景）\\n⑤（第五个场景）\\n⑥（第六个场景）\\n⑦（第七个场景，如情节更多继续写⑧⑨⑩）",
      "turning": "转折点——渣男/女二做了某件让局势突然恶化的行动，或女主被逼到极致做了一个妥协/沉默/顺从的行为（60字内）。❌绝对不是女主察觉/意识到/发现/推断出任何事",
      "emotion": "情绪点①——①（第一个情绪节点：什么具体场景→读者感受到什么）\\n②（第二个情绪节点）\\n③（第三个情绪节点）"
    },
    {
      "segment": "中段",
      "setup": "①（第一个场景：出院后渣男/女二做的第一件伤害的事，比第一阶段更深，4-5句话）\\n②（第二个场景）\\n③（第三个场景）\\n④（第四个场景）\\n⑤（第五个场景）\\n⑥（第六个场景）\\n⑦（第七个场景）\\n⑧（第八个场景，如情节更多继续写⑨⑩）",
      "turning": "转折点——在又一次被虐之后，女主下定决心离开，写她拎包/出门/签字/消失的那个动作（60字内）。❌不是她发现了什么/查到了什么，是行动，不是认知。示例：「女主沉默地收拾了一个行李箱，趁夜离开」",
      "emotion": "情绪点②——①（第一个情绪节点：什么具体场景→读者感受到什么）\\n②（第二个情绪节点）\\n③（第三个情绪节点）"
    },
    {
      "segment": "后段",
      "setup": "①（渣男发现家里空了的那一刻：具体看到了什么、第一反应是什么，3-4句）\\n②（渣男打电话找人/去找人被骂/被拒，具体经过）\\n③（渣男翻到触目惊心的东西：日记/B超单/录像/旧照/短信，写他当场看到了什么内容、崩溃的样子）\\n④（渣男再次去找女主，女主的冷漠态度和具体回应）\\n⑤（真相揭露：女二设局的证据曝光，渣男得知真相后的反应）\\n⑥（渣男跪地求饶/崩溃追悔，女主的最终态度，如情节更多继续写⑦）",
