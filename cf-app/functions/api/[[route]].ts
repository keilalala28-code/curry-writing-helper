...
返回JSON（不要有其他内容）：
{
  ...
  "outline": [
    {
      "segment": "前段",
      "setup": "铺垫情节（第一阶段）【强制要求：至少7条，每条至少60字，总字数不少于500字】——用①②③④⑤⑥⑦以上逐条写，每条是一个故事切片：3-5个连续动作，写渣男/女二做了什么、说了什么、接着发生了什么、女主当时怎么了。禁止一句话摘要，禁止「女主调查/计划/配合/布局」。",
    ...
    {
      "segment": "中段",
      "setup": "铺垫情节（第二阶段）【强制要求：至少8条，每条至少80字，总字数不少于700字】——用①②③④⑤⑥⑦⑧以上逐条写，每条是一个故事切片：3-5个连续动作，伤害比第一阶段更深。写渣男/女二做了什么、说了什么、接着发生了什么、女主的反应、反应之后她被怎么进一步惩罚。禁止一句话摘要，禁止「女主调查/计划/配合/布局」。",
    ...
    {
      "segment": "后段",
      "setup": "铺垫情节（第三阶段）【强制要求：至少6条，每条至少60字，总字数不少于400字】——用①②③④⑤⑥以上逐条写，每条是一个故事切片：女主离开后渣男发现真相的经过、追妻的具体行动、看到了什么触目惊心的东西（日记/B超单/录像/短信/旧照片）、他崩溃的具体样子。有连续动作有细节。",
