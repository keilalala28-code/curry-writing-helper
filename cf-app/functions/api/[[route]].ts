...
一条里可以包含3-5个连续的小动作，串成一个完整的小事件。字数不限，写够为止，宁多勿少。
...
返回JSON（不要有其他内容）：
{
  ...
  "outline": [
    {
      "segment": "前段",
      "setup": "铺垫情节（第一阶段）——用①②③④⑤列出5个以上具体事件，每条像故事切片：写渣男/女二做了什么具体的事、说了什么话、一连串发生了什么、女主当时怎么了。有对话、有动作、有连续经过。禁止出现「女主调查/计划/配合/布局」。字数宁多勿少。",
      "turning": "转折点——让局势开始偏离的那一刻（60字内）",
      "emotion": "情绪点①——用①②③列出读者此时的情绪反应（80字内）"
    },
    {
      "segment": "中段",
      "setup": "铺垫情节（第二阶段）——用①②③④⑤⑥列出6个以上具体事件，每条像故事切片：一个事件里可以有3-5个连续动作，写渣男/女二做了什么、说了什么、接着发生什么、女主怎么了。女主可以有情绪反应但结果是被压得更惨。禁止出现「女主调查/计划/配合/布局」。伤害比第一阶段更重，字数宁多勿少。",
      "turning": "转折点——全文最大的情节反转（60字内）",
      "emotion": "情绪点②——用①②③列出（80字内）"
    },
    {
      "segment": "后段",
      "setup": "铺垫情节（第三阶段）——女主离开后，用①②③④⑤列出5个以上具体事件，写渣男发现真相的经过、他做了什么追妻行动、他看到了什么触目惊心的东西（日记/B超单/录像/短信）、他崩溃的样子。每条像故事切片，有连续动作有细节。字数宁多勿少。",
