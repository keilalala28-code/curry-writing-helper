...
请按以下格式输出，标签独占一行后紧跟内容，不输出JSON：

铺垫故事是最重要的部分，必须先把三个阶段的故事全部写完，再写后面的结构分析。

第一阶段铺垫（写4-5个场景，每个场景是独立段落，每段必须包含：具体触发事件、人物说的话、其他角色反应、女主被迫承受的结果，每段至少5句话。场景类型：男主当面偏袒女二的具体行为；女二设局女主被罚的完整经过；家人当面指责女主含他们的原话；公开场合女主被旁观者围观羞辱。直接写正文故事，不要写编号，不要写摘要）：
[STORY-S1]

第二阶段铺垫（写4-5个场景，比第一阶段更惨，每段同样要求至少5句。场景类型：女主身体或精神受到更深程度伤害的细节；女主向某人求助被拒绝或被反骂含对话原文；女主试图反抗结果被更惨地对待；压垮女主彻底死心的最后一件事——是被虐到极致，不是发现真相。直接写正文故事，不要写编号）：
[STORY-S2]

第三阶段追妻（全程男主视角，女主已离开，写6个场景，每段至少4-5句。场景类型：男主回家发现空了他的慌乱；男主疯狂找人被骂被拒含对方骂他的话；男主外表变得狼狈状态崩溃；男主翻到日记或B超单或录音当场崩溃写出具体内容；男主找到女主女主冷漠拒绝男主跪求；男主发现女二阴谋全貌对女二崩溃清算。直接写正文，不要写编号）：
[STORY-S3]

结构分析（写完上面三段故事后填写）：
[SUMMARY]一句话梗概（30字内，写悲剧被虐感，不写觉醒复仇）
[QI]起——开篇情境（60字内）
[CHENG]承——渣男/女二施害升级（60字内）
[ZHUAN]转——女主离开的动作（60字内，是行动不是发现真相）
[HE]合——男主后来发现真相疯狂追妻（60字内）
[DESIRE]欲望——女主最初只想要什么（40字内）
[OBSTACLE]阻碍——渣男和女二怎么施害（用①②分点，80字内）
[ACTION]行动——女主离开（40字内，只写离开动作）
[ACHIEVE]达成——离开后男主追悔莫及（60字内）
[PROTAGONIST]主角势力（30字内）
[ANTAGONIST]反派势力（20字内）
[BYSTANDERS]围观群众（20字内，无则写「无」）
[EMOT-ELEM]情绪点要素与转折点（用1.2.分点，100字内）
[TURN1]第一阶段转折点（60字内，写渣男/女二让局势恶化的行动，❌不写女主察觉真相）
