...
返回JSON（不要有其他内容）：
{
  ...
  "outline": [
    {
      "segment": "前段",
      "event_1": "虐女主事件①（4-6句完整叙述：触发→其他人反应→女主处境。示例：「女二说自己低血糖要晕倒，男主大半夜冲回家，看都没看女主一眼直接去卧室给女二端水。女主在客厅坐着，那天是她手术后第三天。男主出来时看到女主脸色不好，说『你怎么这么自私，她生病你也要争风吃醋』」）",
      "event_2": "虐女主事件②（换一种伤害类型，4-6句：触发→连锁反应→女主状态）",
      "event_3": "虐女主事件③（家庭集体背刺场景：父母/儿子/公婆当面说的话，女主在场，4-6句含对话）",
      "event_4": "虐女主事件④（必填，不能省略，不能写「无」。围绕用户点子创作第四件伤害：比如身体伤害/金钱剥削/在公开场合当众羞辱，4-6句叙述）",
      "event_5": "虐女主事件⑤（可选，如有第五件继续写，否则填「无」）",
      "turning": "转折点——渣男/女二做了某件让局势突然恶化的行动（60字内）。示例：「丈夫在医院签字同意延长女主住院期，女主透过铁窗看见他签完字转身离去的背影」——写对方的行动，不写女主察觉任何事",
      "emotion": "情绪点①——①（具体场景→读者情绪）\\n②（第二个节点）\\n③（第三个节点）"
    },
    {
      "segment": "中段",
      "event_1": "虐女主升级事件①（比第一阶段更深，身体或精神极端伤害，4-6句叙述）",
      "event_2": "虐女主升级事件②（家人当众羞辱/抛弃女主，有具体对话，女主无处可逃，4-6句）",
      "event_3": "虐女主升级事件③（女主曾试图反抗或求助，结果被更恶劣地对待，4-6句）",
      "event_4": "压垮骆驼的最后一根稻草：某个让女主情感上彻底死心的事件（4-6句）。示例：「儿子当着邻居的面叫女二「妈妈」，女主站在门口，脸上的笑容慢慢没了。那是女儿的忌日。」❌不是发现真相，是心彻底死了",
      "event_5": "虐女主升级事件⑤（可选，如有继续写，否则填「无」）",
      "turning": "转折点——写女主离开的那个动作（60字内）。示例：「那天傍晚，女主把离婚协议放在桌上，拎着一个箱子出了门，什么都没说，也没回头」❌不是发现证据/真相，是行动",
      "emotion": "情绪点②——①（具体场景→读者情绪）\\n②（第二个节点）\\n③（第三个节点）"
    },
    {
      "segment": "后段",
      "event_1": "男主事件①：回家发现空了（推开门看到空荡荡的细节——第一反应——他做了什么，4-5句，全程男主视角）",
      "event_2": "男主事件②：疯狂打电话/找人（打给谁、被骂/被挂断、他的反应，4-5句含对话）",
      "event_3": "男主事件③：变得狼狈（外表/状态描写——某人见到他的反应，4-5句）",
      "event_4": "男主事件④：翻到触目惊心的东西（看到日记/B超单/视频/旧短信什么具体内容——他当场崩溃的样子，4-6句）",
      "event_5": "男主事件⑤：找到女主（女主冷漠态度——男主跪求/痛哭的具体样子，4-5句）",
      "event_6": "男主事件⑥：真相揭露（第三方或物证让男主得知女二阴谋——他对女二的崩溃反应，4-6句）",
      "event_7": "男主事件⑦（可选，如有继续写，否则填「无」）",
      "turning": "转折点——真相在男主面前揭露（60字内）。示例：「男主翻到那段视频，看见女二当晚和纵火者在一起，他手机掉在地上，久久没动」——写真相打击了男主",
