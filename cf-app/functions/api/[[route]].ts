...
- 第一阶段铺垫：至少7条，每条至少60字，该字段总字数不少于500字
- 第二阶段铺垫：至少8条，每条至少80字，该字段总字数不少于700字
- 第三阶段铺垫：至少6条，每条至少60字，该字段总字数不少于400字
- 三个铺垫字段合计总字数不少于1600字
...
【三阶段分工】：
第一、二阶段：渣男/女二施害，写具体事件经过，女主的情绪反应会让处境更糟，无策略无布局
第三阶段：女主离开后，渣男发现真相、追妻、后悔，写他的具体行动，女主态度冷漠/拒绝

【铺垫条数强制检查——生成JSON前在脑中过一遍，不达标必须补足】
第一阶段 setup 字段：你必须数到 ⑦ 才可以停笔。写完①后问自己「还够7条吗？」——不够继续写②③④⑤⑥⑦。
第二阶段 setup 字段：你必须数到 ⑧ 才可以停笔。写完①后问自己「还够8条吗？」——不够继续写②③④⑤⑥⑦⑧。
第三阶段 setup 字段：你必须数到 ⑥ 才可以停笔。

⚠️ 写了 ③ 就想结尾 = 不合格，必须强制继续写。
⚠️ 铺垫不是写「发生了什么（一句话摘要）」，而是写「当时怎么回事（含动作+对话+结果的完整片段）」。
每一条铺垫都必须包含3个以上连续句子，像这样：

【合格示例-动作细节】④女二玩狗、故意要住这里。男主让她别惹事，女二说我装大度，让狗咬我。我自己上了药，半夜着火了。男主救狗，都不救女主。女主倒在血泊中。
【不合格示例-动作细节】④女二故意让狗咬女主。（只有一句话，太简）

【合格示例-行为展开】⑤丈夫那段时间回家从不和女主说话，女主做好饭叫他，他看都不看直接拿手机进卧室，女主站在饭桌前问「你怎么了」他说「没事，累了」，说完反锁门。女主在门外站了十分钟，听见他里面接了个电话，声音低而温柔。
【不合格示例-行为展开】⑤丈夫对女主冷暴力。（「冷暴力」是标签，没有写出任何具体行为）

【合格示例-教唆展开】⑥女二趁女主不在，把儿子叫到跟前说「妈妈不爱你了，你看她最近都没时间管你」，还哭着说「姨妈才是真心疼你的人」。女主回来，儿子不叫妈了，女主问他怎么了，他把脸转开说「我不想理你」。
【不合格示例-教唆展开】⑥女二教唆儿子疏远女主。（「教唆」是标签，没有写出说了什么话、儿子怎么变化）
...
返回JSON（不要有其他内容）：
{
  ...
  "outline": [
    {
      "segment": "前段",
      "setup": "【必须写满 ①②③④⑤⑥⑦ 共7条以上，少于7条不合格，写完⑦还没用完故事情节就继续写⑧⑨⑩】每条必须是含3个以上连续句子的故事片段（有动作有对话有结果），不是一句话摘要。写渣男/女二做了什么、说了什么、接着发生了什么、女主当时怎么了。禁止「女主调查/计划/配合/布局」。",
      "turning": "转折点——渣男/女二做了一件让局势突然恶化的事，或女主被迫做了一个顺应/妥协/沉默的行为（60字内）。❌不是女主察觉/意识到/发现/查到任何事，写的是外部事件，不是女主的内心变化",
      "emotion": "情绪点①——用①②③列出3个让读者情绪共振的具体节点（80字内）：每条写「什么场景→读者有什么感受」，要有具体动作/对话，不是抽象标签"
    },
    {
      "segment": "中段",
      "setup": "【必须写满 ①②③④⑤⑥⑦⑧ 共8条以上，少于8条不合格，写完⑧还有情节就继续写⑨⑩】每条必须比第一阶段更详细，含4个以上连续句子的故事片段，伤害程度比第一阶段更深。写渣男/女二做了什么、说了什么、接着发生了什么、女主的反应、反应之后她被怎么进一步惩罚。禁止一句话摘要，禁止「女主调查/计划/配合/布局」。",
      "turning": "转折点——女主做了一个决定性的离开/出逃/和离行动（60字内）。❌不是女主发现了什么/查到了什么，写的是她走了/离开了/选择了什么，是行动不是认知。示例：「女主拉着行李坐飞机离开」",
      "emotion": "情绪点②——用①②③列出3个具体情绪节点（80字内）：每条写「什么场景→读者有什么感受」，要有具体事件，不是抽象标签"
    },
    {
      "segment": "后段",
      "setup": "【必须写满 ①②③④⑤⑥ 共6条以上，少于6条不合格】每条必须是含3个以上连续句子的故事片段：女主离开后渣男发现真相的经过、追妻的具体行动、看到了什么触目惊心的东西（日记/B超单/录像/短信/旧照片）、他崩溃的具体样子。有连续动作有细节。",
      "turning": "转折点——渣男看到了触目惊心的东西（日记/B超单/录像/旧照片）后的崩溃一刻（60字内）。写渣男发现了什么、他当场的反应。❌不是女主做任何事",
      "emotion": "情绪点③——用①②③列出追妻火葬场的3个具体爽点（80字内）：写渣男后悔/崩溃的具体行为、女主冷漠回应的态度、读者最解气的结局时刻。要有具体场景，不是「治愈圆满」这种抽象词"
    }
  ],
  "emotion_arc": {
