...
【铺垫情节写法要求——核心中的核心，必须严格执行】

这类故事的叙事逻辑是：渣男/女二不断伤害女主 → 女主承受或有情绪反应但被压得更惨 → 女主终于决定离开 → 付费后男主追妻。
铺垫阶段的主语永远是渣男和女二，不是女主。女主在这个阶段没有策略、没有主动调查、没有隐忍计划——她只是一个被反复伤害的人。

【绝对禁止出现的写法（凡是出现就是错误）】：
✗ 女主暗中调查 / 女主秘密收集证据 / 女主配合xxx以获取信任
✗ 女主计划xxx / 女主决定忍耐等待时机 / 女主开始布局
✗ 任何暗示女主有主动策略、有计划的句子

【正确的写法逻辑】：
渣男/女二做了某件具体的坏事 → 女主受到了什么具体的伤害。
女主可以有情绪反应（哭、崩溃、争吵、扇人），但每次反应都导致她被压得更惨，不是反击成功。

【格式】：每条铺垫是一个具体的小场景，60-100字，像故事切片，包含：谁做了什么、说了什么、女主怎么了。可以一条里有2-3个连续动作。

【示例——对照这个写】：
①结婚纪念日，女主值班，女二打电话让渣男过来，渣男二话不说拔腿就走，连饭桌上的女主都没打招呼，女主一个人对着两人份的烛光晚餐坐到凌晨
②女二在婆婆面前哭说「嫂子当众羞辱我」，渣男拉着女主去道歉，女主不肯，渣男说「你就不能让着她一次」，婆婆在旁边说「这孩子就是这个性子，你多担待」
③女主流产当天，渣男接到女二电话，说「我先去看看她，你自己打车去医院」——女主站在手术室门口，等了四个小时没等到人
④女二当众说女主做的菜「有点奇怪的味道」，渣男皱眉放下筷子，第二天叫了外卖，再没碰女主做的饭
⑤女主发烧39.5度，渣男出门前摸了一下她额头，说「喝点水，我去看看她，很快回来」——两天后才回

【三阶段分工】：
第一、二阶段：渣男/女二持续施害，女主每次反应（争吵/崩溃/哭泣）都被当成「她有问题」，反而受到更多惩罚
第三阶段：女主决定离开之后，渣男才开始发现失去、后悔、追妻——写渣男的具体反应和行动，不是女主的感受
...
返回JSON（不要有其他内容）：
{
  ...
  "outline": [
    {
      "segment": "前段",
      "setup": "铺垫情节（第一阶段）——渣男/女二对女主做的具体事，禁止出现「女主调查/计划/配合」。用①②③④⑤逐条列出5个以上具体小场景，每条格式：[渣男/女二][做了什么/说了什么] → [女主受到的具体伤害/委屈结果]（每条60-100字，像故事切片，有对话有行动有后果）",
      "turning": "转折点——让局势开始偏离的那一刻（60字内）",
      "emotion": "情绪点①——用①②③列出读者此时的情绪反应（80字内）"
    },
    {
      "segment": "中段",
      "setup": "铺垫情节（第二阶段）——伤害升级，禁止出现「女主调查/计划/配合」。用①②③④⑤⑥逐条列出6个以上具体小场景，每条格式：[渣男/女二][做了什么/说了什么] → [女主受到的具体后果，可以包含女主的情绪崩溃但崩溃后她被进一步惩罚]（每条60-100字，伤害比第一阶段更重，女主每次反应都让处境更糟）",
      "turning": "转折点——全文最大的情节反转（60字内）",
      "emotion": "情绪点②——用①②③列出（80字内）"
    },
    {
      "segment": "后段",
      "setup": "铺垫情节（第三阶段）——女主已决定离开，渣男开始意识到失去、后悔、追妻。用①②③④⑤逐条列出5个以上具体小场景，每条格式：[渣男][发现了什么/做了什么具体挽回行动] → [女主的冷漠/拒绝反应，或真相进一步揭开]（每条60-100字，渣男越卑微越好，女主这时候才有主动权）",
