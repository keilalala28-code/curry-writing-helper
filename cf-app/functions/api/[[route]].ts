...
请分两步输出——第一步写铺垫草稿，第二步输出JSON。

═══════════════════════════════════
第一步：铺垫草稿（先写这里，自由发挥，不限格式）
每个事件必须4-6句话，包含：触发行为 + 具体对话 + 其他人反应 + 女主处境
═══════════════════════════════════

【第一阶段铺垫，写4个虐女主事件】

事件A（男主明显把女二放在女主前面的一次）：
[在这里写4-6句完整叙述]

事件B（女二设局陷害或挑衅，女主被罚）：
[在这里写4-6句完整叙述，含对话]

事件C（公婆/儿子/家人当面指责女主的场景）：
[在这里写4-6句完整叙述，写出原话对话]

事件D（公开场合/众人面前，女主被严重羞辱）：
[在这里写4-6句完整叙述]

【第二阶段铺垫，写4个更严重的虐女主事件】

事件E（身体或精神更深程度的伤害，比第一阶段惨）：
[在这里写4-6句完整叙述]
...
事件H（压垮骆驼的最后一根稻草，女主心死，❌不是发现真相）：
[在这里写4-6句完整叙述，写她内心断裂的瞬间]
...
事件④（男主翻到触目惊心的东西——日记/B超单/录音/视频）：
[在这里写4-6句，写出具体内容和他崩溃的样子]

事件⑤（男主找到女主，被冷漠拒绝）：
[在这里写4-5句，写女主说的话和男主跪求的样子]

事件⑥（男主发现女二阴谋的具体证据，对女二清算）：
[在这里写4-6句]

═══════════════════════════════════
第二步：将上面草稿内容填入JSON（每个event字段必须复制草稿原文，不能缩短或总结）
═══════════════════════════════════

{
  ...
  "outline": [
    {
      "segment": "前段",
      "event_1": "复制上面草稿「事件A」的完整原文，不删减",
      "event_2": "复制上面草稿「事件B」的完整原文，不删减",
      "event_3": "复制上面草稿「事件C」的完整原文，不删减",
      "event_4": "复制上面草稿「事件D」的完整原文，不删减",
      "event_5": "无",
      "turning": "转折点——渣男/女二做了某件让局势突然恶化的行动（60字内，❌不写女主察觉/发现任何真相）",
      "emotion": "情绪点①——①（具体场景→读者情绪）\\n②（第二个节点）\\n③（第三个节点）"
    },
    {
      "segment": "中段",
      "event_1": "复制上面草稿「事件E」的完整原文，不删减",
      "event_2": "复制上面草稿「事件F」的完整原文，不删减",
      "event_3": "复制上面草稿「事件G」的完整原文，不删减",
      "event_4": "复制上面草稿「事件H」的完整原文，不删减",
      "event_5": "无",
      "turning": "转折点——写女主离开的那个动作（60字内，❌不写发现真相，只写她的离开行动）",
      "emotion": "情绪点②——①（具体场景→读者情绪）\\n②（第二个节点）\\n③（第三个节点）"
    },
    {
      "segment": "后段",
      "event_1": "复制上面草稿「事件①」的完整原文，不删减",
      "event_2": "复制上面草稿「事件②」的完整原文，不删减",
      "event_3": "复制上面草稿「事件③」的完整原文，不删减",
      "event_4": "复制上面草稿「事件④」的完整原文，不删减",
      "event_5": "复制上面草稿「事件⑤」的完整原文，不删减",
      "event_6": "复制上面草稿「事件⑥」的完整原文，不删减",
      "event_7": "无",
      "turning": "转折点——真相在男主面前揭露（60字内）",
