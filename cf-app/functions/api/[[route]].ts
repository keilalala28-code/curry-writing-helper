...
返回JSON（不要有其他内容）：
{
  "summary": "一句话梗概（30字内，有冲突张力的钩子。❌不写「觉醒」「反杀」「复仇」，写被虐的悲剧感）",
  "structure": {
    "qi": "起——开篇情境，直接进入情绪现场（60字内）",
    "cheng": "承——渣男/女二如何一次次升级伤害，女主被所有人抛弃、陷入绝境（60字内）。❌绝对不写：逐渐发现真相/开始觉醒/开始布局",
    "zhuan": "转——女主被虐到某个极限后决定离开/出走/离婚，写她离开的动作（60字内）。❌绝对不写：发现证据/策划复仇/查明真相",
    "he": "合——男主追悔莫及，真相揭露（由第三方或渣男自己发现），女主冷漠拒绝不回头（60字内）"
  },
  "event_flow": {
    "desire": "欲望——女主最初只想要什么简单的东西（家庭/爱/稳定），写这个被剥夺的东西（40字内）",
    "obstacle": "阻碍——渣男和女二如何持续制造障碍（用①②分点，80字内）",
    "action": "行动——女主在被虐到极致后，做了一个行动：离开。写她怎么离开（40字内）。❌不写：暗中调查/假装顺从/策划布局/复仇",
    "achieve": "达成——最终结果：女主离开后的状态，男主追悔（60字内）"
  },
  "characters": {
  ...
  "outline": [
    {
      "segment": "前段",
      "setup": "①（施害事件1：女二/渣男做了第一件具体的伤害——其他家庭成员怎么反应/站队——女主被迫面对什么处境，4-6句叙述，有人物动作和对话）\\n②（施害事件2：与①不同类型的伤害，比如身体伤害/金钱控制/孩子被挑拨，4-6句展开，有具体细节）\\n③（家庭集体背刺：父母/儿子/公婆当面说了什么话偏袒女二，女主在场，4-6句叙述，包含对话）\\n④（施害升级：比前三件更狠的一次，女主情绪崩溃或被彻底压制，4-6句展开）\\n⑤（如有更多施害场景继续写⑤，否则此处写「（第一阶段共四个事件）」）",
      "turning": "转折点——渣男/女二做了某件让局势突然恶化的行动，或女主被逼到极致做了一个妥协/沉默/顺从的行为（60字内）。❌绝对不是女主察觉/意识到/发现/推断出任何事",
      "emotion": "情绪点①——①（第一个情绪节点：什么具体场景→读者感受到什么）\\n②（第二个情绪节点）\\n③（第三个情绪节点）"
    },
    {
      "segment": "中段",
      "setup": "①（升级伤害1：比第一阶段更深一层的施害，身体/心理上更极端，4-6句叙述，有触发+反应+女主状态）\\n②（家庭关系彻底恶化：家人当众羞辱/抛弃女主的场景，有具体对话，女主无处可逃，4-6句展开）\\n③（女主曾尝试反抗或求助：她做了什么——对方怎么更恶劣地对待她——女主比之前更惨，4-6句叙述）\\n④（压垮骆驼的最后一根稻草：某个具体的事件让女主情感上彻底死心，不再抱希望，4-6句展开。❌不是女主发现了什么真相，是她的心彻底死了）",
      "turning": "转折点——在又一次被虐之后，女主下定决心离开，写她拎包/出门/签字/消失的那个动作（60字内）。❌不是她发现了什么/查到了什么，是行动，不是认知。示例：「女主沉默地收拾了一个行李箱，趁夜离开」",
      "emotion": "情绪点②——①（第一个情绪节点：什么具体场景→读者感受到什么）\\n②（第二个情绪节点）\\n③（第三个情绪节点）"
    },
    {
      "segment": "后段",
      "setup": "①（男主回家发现空了：他推开门看到了什么——空荡荡的细节——他第一反应做了什么，4-5句叙述，全是男主视角）\\n②（男主疯狂联系女主：打了几个电话无人接——去找女主的闺蜜/父母——被骂/被拒的具体经过，4-5句展开，有对话）\\n③（男主变得狼狈：描述他这段时间的状态——不整洁/不睡觉/找遍所有地方——某个人见到他的反应，4-5句叙述）\\n④（男主翻到触目惊心的东西：日记/B超单/录像/旧信息——他读到/看到了什么具体内容——他当场崩溃的样子，4-6句展开）\\n⑤（男主找到女主：女主冷漠的具体态度——说了什么或一个字不说——男主跪下/哭泣/求饶的具体样子，4-5句展开）\\n⑥（真相彻底揭露：女二设局的证据/证人出现——男主得知真相——他对着女二的崩溃反应，4-6句展开，女主在远处冷眼旁观）\\n⑦可选（如有更多追妻情节继续写⑦⑧）",
      "turning": "转折点——真相彻底揭露的那一刻（60字内）：证据出现、或女主当面告知、或旁人揭穿，渣男/女二当场崩溃。❌不是写女主有多厉害，写的是真相打击了谁",
      "emotion": "情绪点③——①（追妻火葬场第一个爽点：渣男做了什么、女主冷漠拒绝的具体场景）\\n②（第二个爽点：真相大白时旁人的反应或渣男的崩溃）\\n③（结局最解气的时刻：女主的最终状态，写具体场景，不是「治愈圆满」这种空洞词）"
    }
  ],
  "emotion_arc": {
