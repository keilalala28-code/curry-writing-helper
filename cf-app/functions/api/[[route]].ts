...
【铺垫情节写法要求——这是最核心的部分，请严格执行】

每一条铺垫必须是「渣男/反派对女主做的具体事」，不是女主的行动摘要。
格式要求：「[谁] [做了什么具体动作/说了什么话]，[女主受到什么具体伤害/委屈]」
每条 40-80 字，写得像故事节选，有场景感，有对话片段，有具体后果。
禁止写「女主配合xxx」「女主暗中调查」「女主忍耐」这类以女主为主语的行动句——铺垫阶段女主只是承受，施害方才是主语。

阶段分工：
- 第一、二阶段：渣男和女二持续施害，女主全程承受，不反击不觉醒
- 第三阶段：渣男/反派开始发现真相、离不开女主、开始后悔，写他们的具体行动和心理变化

正确示例（每条都是施害方的具体行为）：
①女二突然晕倒，渣男当着女主面把她横抱冲去医院，连「等我一下」都没说，女主站在原地等了两个小时
②女二在饭桌上说「姐姐做的菜真好吃」，渣男顺口说「比你强多了」，全桌人哄笑，女主端着碗没动
③女主流产住院，渣男接到女二电话说「马上来」，当着护士的面把女主的手甩开就走
④女二当众指着女主的礼物说「这也太廉价了」，渣男非但没反驳，还说「下次让我帮你挑」
⑤女主发烧到39度，渣男因为女二一条消息连夜开车两小时去陪她，留女主一个人在家烧了一整夜
...
返回JSON（不要有其他内容）：
{
  ...
  "outline": [
    {
      "segment": "前段",
      "setup": "铺垫情节（第一阶段）——渣男/反派对女主做的具体事，女主只承受不反击。用①②③④⑤逐条列出5个以上具体场景，每条写：[施害方][做了什么/说了什么]，[女主受到的具体伤害]（每条40-80字，有场景感，有对话，有后果）",
      "turning": "转折点——让局势开始偏离的那一刻（60字内）",
      "emotion": "情绪点①——用①②③列出读者此时的情绪反应（80字内）"
    },
    {
      "segment": "中段",
      "setup": "铺垫情节（第二阶段）——渣男/反派对女主的伤害升级，不写反击。用①②③④⑤⑥逐条列出6个以上具体场景，每条写：[施害方][做了什么/说了什么]，[女主受到的具体伤害/委屈]（每条40-80字，有场景感，有对话，有后果，伤害程度比第一阶段更深）",
      "turning": "转折点——全文最大的情节反转（60字内）",
      "emotion": "情绪点②——用①②③列出（80字内）"
    },
    {
      "segment": "后段",
      "setup": "铺垫情节（第三阶段）——渣男/反派开始发现真相、意识到失去、后悔。用①②③④⑤逐条列出5个以上具体场景，每条写：[渣男][发现了什么/做了什么挽回动作/有什么具体反应]（每条40-80字，写他的具体行为和内心，局势开始反转但女主还未原谅）",
