...
返回JSON（不要有其他内容）：
{
  ...
  "outline": [
    {
      "segment": "前段",
      "setup_plan": "列出本阶段要写的全部虐女主事件标题（至少4个，格式：事件A/B/C/D）：",
      "setup": "（根据setup_plan展开，每个事件4-6句，有触发+他人反应+女主处境）\\n①（事件A展开）\\n②（事件B展开）\\n③（事件C展开）\\n④（事件D展开）\\n⑤（如有事件E继续写）",
      "turning": "转折点——渣男/女二做了让局势突然恶化的行动（60字内）。示例：「丈夫在医院签字同意延长女主住院，女主透过铁窗看着他转身离去」——写他们的行动，不写女主察觉任何事",
      "emotion": "情绪点①——①（具体场景→读者情绪）\\n②（第二个节点）\\n③（第三个节点）"
    },
    {
      "segment": "中段",
      "setup_plan": "列出本阶段要写的全部虐女主事件标题（至少4个，续前段编号）：",
      "setup": "（根据setup_plan展开，每个事件4-6句，比第一阶段更深）\\n①（升级伤害事件A展开）\\n②（升级伤害事件B展开）\\n③（升级伤害事件C展开）\\n④（最后一根稻草：让女主心彻底死的事件，不是发现真相，是心死）",
      "turning": "转折点——女主决定离开的那个动作（60字内）。示例：「那天下午女主一个人把离婚协议放在茶几上，拎着一个箱子出了门，什么都没说」——是离开动作，不是发现证据",
      "emotion": "情绪点②——①（具体场景→读者情绪）\\n②（第二个节点）\\n③（第三个节点）"
    },
    {
      "segment": "后段",
      "setup_plan": "列出本阶段男主追妻的全部事件标题（6-8个，全部男主视角，女主已离开）：",
      "setup": "（⚠️本段全部是男主视角，女主已不在家，根据setup_plan展开每个事件4-5句）\\n①（男主回家发现空了展开）\\n②（男主疯狂找人、被骂/被拒展开）\\n③（男主狼狈状态展开）\\n④（男主翻到遗物/日记/监控崩溃展开）\\n⑤（男主找到女主、女主冷漠拒绝展开）\\n⑥（真相由第三方/物证揭露，男主得知女二阴谋崩溃展开）\\n⑦（如有更多继续写）",
      "turning": "转折点——真相在男主面前揭露（60字内）。示例：「男主翻到那段视频，看见女二当晚和纵火者在一起，他手机掉在地上，久久没动」——写真相打击了男主",
      "emotion": "情绪点③——①（男主追妻第一个爽点，女主冷漠拒绝）\\n②（真相大白，旁人/渣男崩溃）\\n③（结局最解气的场景）"
    }
  ],
  "emotion_arc": {
